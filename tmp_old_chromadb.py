...
# ΓöÇΓöÇΓöÇ Chunking Helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
def _chunk_by_page(text):
    """
    Strategy: 'page' ΓÇö one chunk per PDF page.
...
def _chunk_by_fixed(text, chunk_size=1000, chunk_overlap=200):
    """
    Strategy: 'fixed' ΓÇö fixed-size character windows with overlap.
...
def _chunk_by_paragraph(text, chunk_size=1200):
    """
    Strategy: 'paragraph' ΓÇö split on double-newlines, merge small paragraphs
    up to chunk_size.
...
# ΓöÇΓöÇΓöÇ aHash Helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ PDF Vector Store ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
class PDFVectorStore:
    ...
    # ΓöÇΓöÇ Text Import ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def import_pdf(
        ...
        Args:
            ...
            chunk_strategy (str): Chunking strategy ΓÇö 'page', 'fixed', or 'paragraph'.
        ...
        Chunking Strategy Recommendations:
            ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
            Γöé Document Type           Γöé Strategy   Γöé chunk_size Γöé overlap Γöé
            Γö£ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöñ
            Γöé General documents       Γöé 'fixed'    Γöé 1000       Γöé 200     Γöé
            Γöé Legal / policy docs     Γöé 'fixed'    Γöé 1500       Γöé 300     Γöé
            Γöé Short brochures (<5pp)  Γöé 'page'     Γöé ΓÇö          Γöé ΓÇö       Γöé
            Γöé Structured reports      Γöé 'paragraph'Γöé 1200       Γöé ΓÇö       Γöé
            Γöé Technical manuals       Γöé 'fixed'    Γöé 800        Γöé 150     Γöé
            ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö┤ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö┤ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö┤ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
        ...
        # ΓöÇΓöÇ Deduplication: Remove existing data for this PDF ΓöÇΓöÇ
        ...
        # ΓöÇΓöÇ Step 1: Extract text ΓöÇΓöÇ
        ...
        # ΓöÇΓöÇ Step 2: Chunk text ΓöÇΓöÇ
        ...
        print(f"  ΓåÆ {len(chunks)} chunks created.")

        # ΓöÇΓöÇ Step 3: Embed and store text chunks ΓöÇΓöÇ
        ...
        for batch_start in range(0, len(chunks), batch_size):
            ...
            print(f"  ΓåÆ Indexed {total_indexed}/{len(chunks)} chunks...", end="\r")

        print(f"  ΓåÆ Indexed {total_indexed}/{len(chunks)} chunks. Done.")

        # ΓöÇΓöÇ Step 4: Image extraction + aHash ΓöÇΓöÇ
        images_indexed = 0
        if extract_images_flag:
            ...
            try:
                ...
                if output_dir and Path(output_dir).exists():
                    ...
                    print("  ΓåÆ No images extracted or output directory not found.")

            except Exception as e:
                print(f"  ΓåÆ Image extraction failed: {e}")
                print("  ΓåÆ Continuing without image indexing.")
        else:
    ...
    def _index_images(self, image_dir, source_pdf, full_text=""):
        ...
        if not image_files:
            print("  ΓåÆ No image files found in output directory.")
            return 0
        ...
        for img_path in image_files:
            try:
                ...
                indexed += 1
                print(f"  ΓåÆ [{element_type}] {img_path.name} | aHash: {ahash}")

            except Exception as e:
                print(f"  ΓåÆ Failed to index {img_path.name}: {e}")

        print(f"  ΓåÆ {indexed} images indexed with aHash.")
        return indexed

    # ΓöÇΓöÇ Semantic Search ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def search(self, query, n_results=5, deduplicate=True, dedup_threshold=0.05):
        ...
        # ΓöÇΓöÇ Query-time deduplication ΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Image Hash Retrieval ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Utilities ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def clear(self):
        ...
        # ChromaDB doesn't have a clear() method ΓÇö delete and recreate
